...
var open_component_1 = require('./open.component');
var Modal = (function () {
    ...
    Modal.prototype.open = function (component) {
        ...
        if (component) {
            this.compiler.resolveComponent(component).then(function (factory) {
                return _this.cmpRef = _this.target.createComponent(factory);
            });
        }
    };
    /**
    ...
    Modal = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof core_1.ComponentResolver !== 'undefined' && core_1.ComponentResolver) === 'function' && _a) || Object, core_1.ViewContainerRef])
    ], Modal);
    return Modal;
    var _a;
}());
